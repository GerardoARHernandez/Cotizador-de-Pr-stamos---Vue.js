<script setup>
  ...
  //   cantidad.value = +e.target.value; //Para ref
  //   // state.cantidad = +e.target.value; //Para reactive
  // }
  //SE elimina esta funcion y el value y @input porque v-model lo reemplaza
